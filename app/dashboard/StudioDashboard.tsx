    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Here’s what’s happening with your roles</p>
        </div>
        ...
        <Tabs defaultValue="jobs" className="space-y-6">
          ...
          <TabsContent value="applicants">
            <Card><CardContent className="p-6 text-gray-600">Applicant list UI goes here (filter by job, stage, rating).</CardContent></Card>
          </TabsContent>

          <TabsContent value="interviews">
            <Card><CardContent className="p-6 text-gray-600">Interview schedule UI goes here.</CardContent></Card>
          </TabsContent>
        </Tabs>
      </div>
    </div>
