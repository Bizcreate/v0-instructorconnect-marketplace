    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center space-x-6">
              <Link href="/studio/dashboard" className="text-orange-500 font-medium">Dashboard</Link>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Manage Lagree roles, applicants, interviews, and DMs.</p>
        </div>
        ...
        <Tabs defaultValue="jobs" className="space-y-6">
          ...
          <TabsContent value="applicants">
            <Card>
              <CardContent className="p-6 text-gray-600">
                Applicant list UI (filter by job, stage, rating) — plus quick DM.
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="interviews">
            <Card>
              <CardContent className="p-6 text-gray-600">
                Interview schedule UI — confirm, message, reschedule.
              </CardContent>
            </Card>
          </TabsContent>
        </Tabs>
